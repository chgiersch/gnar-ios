...
struct GameBuilderView: View {
    ...
    init(coreData: CoreDataContexts, onCreateSession: @escaping (GameSession) -> Void) {
        _viewModel = StateObject(wrappedValue: GameBuilderViewModel(coreData: coreData))
...
//                }
//                Task {
//                    await viewModel.fetchMountains()
//                }
//            }
//            .onDisappear {
